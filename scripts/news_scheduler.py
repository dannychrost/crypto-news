...
FETCH_PARAMS = {
    "filter": "hot",         # or "rising", "bullish", etc.
    "currencies": "BTC,ETH", # comma-separated list
    "kind": "news"           # or "media", "all"
}
...
if __name__ == "__main__":
    logging.info("Starting scheduled news fetcher (every 1 hour)...")
    while True:
